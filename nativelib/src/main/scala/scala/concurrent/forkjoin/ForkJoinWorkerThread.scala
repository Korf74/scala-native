...
class ForkJoinWorkerThread(final var pool: ForkJoinPool) extends Thread("aForkJoinWorkerThread") {

  final var workQueue: ForkJoinPool.WorkQueue = pool.registerWorker(this)// work-stealing mechanics
